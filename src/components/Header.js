...
const Header = ({ className = "" }) => {
  ...
  return (
    <header
      className={`self-stretch flex flex-row items-start justify-center py-[9px] px-5 box-border sticky gap-[332px] top-[0] z-[99] max-w-full text-left text-xl text-black font-body-body-2 mq825:gap-[83px] mq1275:gap-[166px] mq450:gap-[41px] ${className}`}
    >
      ...
      <nav className="m-0 w-[248px] flex flex-col items-start justify-start pt-[17px] px-0 pb-0 box-border mq825:hidden mq450:w-0">
      ...
      <div className="flex flex-row items-start justify-start py-0 pr-[273px] pl-0 box-border gap-[16px] max-w-full mq825:pr-[136px] mq825:box-border">
