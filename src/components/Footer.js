...
const Footer = ({ className = "" }) => {
  return (
    <footer
      className={`self-stretch bg-default-white flex flex-col items-center justify-start py-6 px-5 box-border gap-[41px] max-w-full text-left text-base text-default-black font-body-body-2 mq825:gap-[20px] ${className}`}
    >
      <div className="w-[1590px] flex flex-row items-start justify-center py-0 pr-px pl-0 box-border max-w-full">
        <div className="w-[563px] flex flex-col items-start justify-start gap-[31px] max-w-full mq825:gap-[15px]">
          ...
          <div className="overflow-hidden flex flex-row items-start justify-start gap-[24px] mq825:flex-wrap">
      ...
      <div className="w-[1590px] flex flex-col items-start justify-start gap-[24px] max-w-full text-sm text-gray-300">
        <div className="self-stretch flex flex-row items-start justify-start py-0 px-[55px] box-border max-w-full mq1275:pl-[27px] mq1275:pr-[27px] mq1275:box-border">
          <img
