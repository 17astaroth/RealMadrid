...
const Footer1 = ({ className = "", propMarginLeft }) => {
  ...
  return (
    <footer
      className={`ml-[-1px] self-stretch bg-default-white flex flex-col items-center justify-start py-6 px-5 box-border gap-[41px] max-w-full text-left text-base text-default-black font-body-body-2 mq900:gap-[20px] ${className}`}
      style={footerStyle}
    >
      <div className="w-[1590px] flex flex-row items-start justify-center py-0 pr-px pl-0 box-border max-w-full">
        <div className="w-[563px] flex flex-col items-start justify-start gap-[31px] max-w-full mq900:gap-[15px]">
          ...
          <div className="overflow-hidden flex flex-row items-start justify-start gap-[24px] mq900:flex-wrap">
